        ...
        {!selectedMaterial ? (
          ...
          >
            <div className="w-full max-w-4xl text-center flex flex-col items-center">
              ...
              >
                <h3 className="text-3xl md:text-3xl lg:text-[6rem] font-playfair font-bold mb-12 text-[#0f172a] tracking-tight pointer-events-auto leading-[1.05] drop-shadow-sm">
